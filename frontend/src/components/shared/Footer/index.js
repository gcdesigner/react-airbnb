  ...
  return (
    <Container>
      <Content>
        <Wrapper>
          ...
          <Widget>
            ...
            <ul>
              ...
              <li>
                <a href="/">Viagens e Negócios</a>
              </li>
              <li>
                <a href="/">
                  Coisas para fazer <span>Novo</span>
                </a>
              </li>
              <li>
                <a href="/">Airbnbmag</a>
          ...
          <Widget>
            ...
            <ul>
              <li>
                <a href="/">Por Que Hospedar</a>
              </li>
              <li>
                <a href="/">Hospitalidade</a>
              </li>
              <li>
                <a href="/">Hospedando com Responsabilidade</a>
              </li>
              <li>
                <a href="/">Central da Comunidade</a>
              </li>
              <li>
                <a href="/">
                  Ofereça uma experiência <span>Novo</span>
                </a>
              </li>
              <li>
                <a href="/">Open Homes</a>
        ...
        <CopyRight>
          <Logo size="1.5em" color="#767676" />© 2020 Airbnb, Inc. All rights
          reserved.
        </CopyRight>
      </Content>
    </Container>
